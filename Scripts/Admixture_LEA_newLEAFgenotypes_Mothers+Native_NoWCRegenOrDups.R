...
vcf2lfmm("newLEAFgenotypes_Mothers+Native_NoWCRegenOrDups.vcf", output.file = "newLEAFgenotypes_Mothers+Native_NoWCRegenOrDups", force = TRUE)

# Perform Principal Component Analysis (PCA) on LFMM data
pc = pca("newLEAFgenotypes_Mothers+Native_NoWCRegenOrDups.lfmm", scale = TRUE)
...
project = snmf("newLEAFgenotypes_Mothers+Native_NoWCRegenOrDups.geno",
               K = 1:15,
               entropy = TRUE,
               repetitions = 10,
               project = "new")
...
out = "cross-entropy criterion_newLEAFgenotypes_Mothers+Native_NoWCRegenOrDups.svg"
svg(out)
