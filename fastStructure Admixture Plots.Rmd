...
```
Read in Population data in the same order as the fastStructure output. Columns include Source, Lat, Long etc. Read in the desired order file which is a list of taxa names in the desired order for the output fastStructure plot, in this case the taxa are ordered by Longitute, from West to East. 
